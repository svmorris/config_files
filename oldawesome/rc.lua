...
local themes = {
    "powerarrow-fuckidk",      -- 3
    "powerarrow",      		-- 2
    "multicolor", 			-- 1
    "powerarrow-costome",      -- 3
    "powerarrow-blue",      -- 3
    "powerarrow-monochrome",      -- 3
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "a", function () awful.util.spawn( "pc" ) end,
    ...
    -- ctrl+
    awful.key({ modkey1,           }, "space",  function() awful.spawn.with_shell("com.github.davidmhewitt.clipped --show-paste-window") end,
        {description = "open clipboard manager", group = "alt+ctrl"}),
    ...
    awful.key({ modkey1, altkey }, "l", function () awful.util.spawn( scrlocker ) end,
    ...
    -- super, ctrl 
    awful.key({ modkey, modkey1, }, "l", function () awful.spawn.with_shell( "picom-limited" ) end,
        {description = "set superior layout", group = "keyboard"}),
    awful.key({ modkey, modkey1, }, "a", function () awful.spawn.with_shell( "picom-all" ) end,
        {description = "set superior layout", group = "keyboard"}),

    -- super, ctrl, shift +
    awful.key({ modkey, modkey1, "Shift"   }, "u", function () awful.spawn.with_shell( "setxkbmap gb" ) end,
        {description = "set superior layout", group = "keyboard"}),
    awful.key({ modkey, modkey1, "Shift"  }, "h", function () awful.spawn.with_shell( "setxkbmap hu;sh ~/scripts/fix_hu_layout.sh" ) end,
        {description = "set hungarian layout", group = "keyboard"}),
 ...
 -- Show/Hide Systray
    ...
    awful.key({ modkey1, "Shift" }, "m",
        function ()
            os.execute(string.format("pamixer -i 100", beautiful.volume.channel))
            beautiful.volume.update()
        end),
    awful.key({ modkey1, "Shift" }, "0",
        function ()
            os.execute(string.format("pamixer -d 0", beautiful.volume.channel))
            beautiful.volume.update()
        end),
...
awful.rules.rules = {
    ...
    { rule = { class = "firefox" },
      properties = { screen = 2, tag = awful.util.tagnames[0], switchtotag = true  } },

    { rule = { class = "brave-browser" },
      properties = { screen = 3, tag = awful.util.tagnames[0],switchtotag = true  } },

    { rule = { class = "Discord" },
        properties = { screen = 1, tag = awful.util.tagnames[0],switchtotag = true  } },
...
awful.spawn.with_shell("picom -b --config  $HOME/.config/awesome/picom/all.conf")
awful.spawn.with_shell("compton --config  $HOME/.config/awesome/picom/all.conf")
