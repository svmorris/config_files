...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/powerarrow-monochrome"
theme.wallpaper                                 = theme.dir .. "/160.jpg"
theme.font                                      = "Mononoki Nerd Font 9"
theme.taglist_font                              = "Droid Sans Bold 7"
theme.fg_normal                                 = "#ffffff"
theme.fg_focus                                  = "#A77AC4"
theme.fg_urgent                                 = "#b74822"
theme.bg_normal                                 = "#525252"--taskbar colour
...
theme.border_normal                             = "#012967"
theme.border_focus                              = "#FFFFFF"--"#F07178"
...
theme.weather = lain.widget.weather({
    city_id = 3054643, -- placeholder (Belgium)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            ...
            arrow("alpha", "#000000"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#000000"),

            arrow("#000000", "#525252"),
            wibox.container.background(wibox.container.margin(wibox.widget {  }, 2, 3), "#525252"),
            arrow("#525252", "#000000"),

            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#000000"),

            arrow("#000000", "#525252"),
            wibox.container.background(wibox.container.margin(wibox.widget {  }, 2, 3), "#525252"),
            arrow("#525252", "#000000"),

            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#000000"),

            arrow("#000000", "#525252"),
            wibox.container.background(wibox.container.margin(wibox.widget {  }, 2, 3), "#525252"),
            arrow("#525252", "#000000"),

            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, 4, 4), "#000000"),

            arrow("#000000", "#525252"),
            wibox.container.background(wibox.container.margin(wibox.widget {  }, 2, 3), "#525252"),
            arrow("#525252", "#000000"),

            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#000000"),

            arrow("#000000", "#525252"),
            wibox.container.background(wibox.container.margin(wibox.widget {  }, 2, 3), "#525252"),
            arrow("#525252", "#000000"),

            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#000000"),

            arrow("#000000", "#525252"),
            wibox.container.background(wibox.container.margin(wibox.widget {  }, 2, 3), "#525252"),
            arrow("#525252", "#000000"),

            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#000000"),

            arrow("#000000", "#525252"),
            wibox.container.background(wibox.container.margin(wibox.widget {  }, 2, 3), "#525252"),
            arrow("#525252", "#000000"),

            wibox.container.background(wibox.container.margin(clock, 4, 8), "#000000"),
            arrow("#000000", "alpha"),
            --]]
            s.mylayoutbox,
        },
